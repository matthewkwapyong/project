...
ALTER TABLE
    "chat" ADD CONSTRAINT "chat_user2_foreign" FOREIGN KEY("user2") REFERENCES "users"("id");
ALTER TABLE
    "chatmembers" ADD CONSTRAINT "chatmembers_userid_foreign" FOREIGN KEY("userid") REFERENCES "users"("id");
ALTER TABLE
    "chat" ADD CONSTRAINT "chat_user1_foreign" FOREIGN KEY("user1") REFERENCES "users"("id");
ALTER TABLE
